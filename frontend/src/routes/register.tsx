...
export const Route = createFileRoute("/register")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Create your free PaperLens AI account — AI Question Paper Analyzer" },
    ],
  }),
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden bg-gradient-to-br from-[#0c101a] via-[#101524] to-[#0a0d16] border-r border-border/40 p-12">
        ...
        <div className="relative z-10 max-w-lg text-center">
          ...
          <h1 className="text-4xl font-extrabold text-white tracking-tight mb-3">
            Join PaperLens <span className="bg-gradient-to-r from-indigo-400 via-blue-400 to-cyan-300 bg-clip-text text-transparent">AI</span>
          </h1>
          ...
          <div className="space-y-3 text-left max-w-sm mx-auto">
            {[
              ...
              <div key={f} className="flex items-center gap-3 rounded-xl border border-white/5 bg-white/5 p-2.5 backdrop-blur-sm">
