...
const COLORS = ["#6366f1", "#06b6d4", "#3b82f6", "#10b981", "#8b5cf6"];
...
function AdminAnalyticsPage() {
  ...
  const summaryCards = stats
    ? [
        {
          label: "Avg Docs / User",
          value: (stats.total_documents / Math.max(stats.total_users, 1)).toFixed(1),
        },
        {
          label: "Avg Q / User",
          value: (stats.total_questions / Math.max(stats.total_users, 1)).toFixed(1),
        },
        {
          label: "Storage / User (MB)",
          value: (stats.total_storage_mb / Math.max(stats.total_users, 1)).toFixed(2),
        },
